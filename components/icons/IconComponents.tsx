...
export const GoogleIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
        <path d="M21.35,11.1H12.18V13.83H18.69C18.36,17.64 15.19,19.27 12.19,19.27C8.36,19.27 5,16.25 5,12C5,7.9 8.2,4.73 12.19,4.73C14.03,4.73 15.69,5.36 16.95,6.57L19.05,4.5C17.14,2.73 14.86,1.73 12.19,1.73C6.92,1.73 2.73,6.08 2.73,12C2.73,17.92 6.92,22.27 12.19,22.27C17.6,22.27 21.5,18.33 21.5,12.29C21.5,11.75 21.45,11.42 21.35,11.1Z" />
    </svg>
);
